...
from .models.embedding import FullyConnectedEmbed, AbTransformerEncoder, SkipLSTM
...
def build_human_1(state_dict_path):
    ...
    abModel = FullyConnectedEmbed(256, 100, 0.5)
...
def build_human_ab1(state_dict_path):
    """
    :meta private:
    """
    embModel = FullyConnectedEmbed(6165, 100, 0.5)
    abModel = FullyConnectedEmbed(256, 100, 0.5)
    abTransEnc = AbTransformerEncoder(256, 8, 1)
    conModel = ContactCNN(100, 50, 7)
    model = ModelInteraction(
        embModel,
        abTransEnc,
